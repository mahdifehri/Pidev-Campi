...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\BackEvenementController' => 'getBackEvenementControllerService',
    ...
    /**
     * Gets the public 'App\Controller\BackEvenementController' shared autowired service.
     *
     * @return \App\Controller\BackEvenementController
     */
    protected function getBackEvenementControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'BackEvenementController.php';

        $this->services['App\\Controller\\BackEvenementController'] = $instance = new \App\Controller\BackEvenementController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\BackEvenementController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('I1Om3x1xeX', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C3X010dM1e', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7kvSHaGNxc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HTSGXlppNy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GqMorYnfoG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iykDdYQJoE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getVarDumper_Command_ServerDumpService()
    {
        ...
        $this->privates['var_dumper.command.server_dump'] = $instance = new \Symfony\Component\VarDumper\Command\ServerDumpCommand(new \Symfony\Component\VarDumper\Server\DumpServer('tcp://'.$this->getEnv('string:VAR_DUMPER_SERVER'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))), ['cli' => new \Symfony\Component\VarDumper\Command\Descriptor\CliDescriptor(($this->privates['var_dumper.contextualized_cli_dumper.inner'] ?? $this->getVarDumper_ContextualizedCliDumper_InnerService())), 'html' => new \Symfony\Component\VarDumper\Command\Descriptor\HtmlDescriptor(($this->privates['var_dumper.html_dumper'] ?? $this->getVarDumper_HtmlDumperService()))]);
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder0e153 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5e0e1 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties9be2f = [
        
    ];

    public function getConnection()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getConnection', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getMetadataFactory', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getExpressionBuilder', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'beginTransaction', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getCache', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getCache();
    }

    public function transactional($func)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'transactional', array('func' => $func), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'wrapInTransaction', array('func' => $func), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'commit', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->commit();
    }

    public function rollback()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'rollback', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getClassMetadata', array('className' => $className), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'createQuery', array('dql' => $dql), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'createNamedQuery', array('name' => $name), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'createQueryBuilder', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'flush', array('entity' => $entity), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'clear', array('entityName' => $entityName), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->clear($entityName);
    }

    public function close()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'close', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->close();
    }

    public function persist($entity)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'persist', array('entity' => $entity), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'remove', array('entity' => $entity), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'refresh', array('entity' => $entity), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'detach', array('entity' => $entity), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'merge', array('entity' => $entity), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'contains', array('entity' => $entity), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getEventManager', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getConfiguration', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'isOpen', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getUnitOfWork', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getProxyFactory', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'initializeObject', array('obj' => $obj), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'getFilters', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'isFiltersStateClean', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'hasFilters', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return $this->valueHolder0e153->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer5e0e1 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder0e153) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder0e153 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder0e153->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, '__get', ['name' => $name], $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        if (isset(self::$publicProperties9be2f[$name])) {
            return $this->valueHolder0e153->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder0e153;
    ...
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;
    ...
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, '__isset', array('name' => $name), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;
    ...
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, '__unset', array('name' => $name), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;
    ...
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, '__clone', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        $this->valueHolder0e153 = clone $this->valueHolder0e153;
    }

    public function __sleep()
    {
        $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, '__sleep', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;

        return array('valueHolder0e153');
    }
    ...
    {
        $this->initializer5e0e1 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer5e0e1;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer5e0e1 && ($this->initializer5e0e1->__invoke($valueHolder0e153, $this, 'initializeProxy', array(), $this->initializer5e0e1) || 1) && $this->valueHolder0e153 = $valueHolder0e153;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder0e153;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder0e153;
    }
}
