 ...
 */
final class Version20220216215446 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP fournisseur_id, CHANGE designation designation VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE quantite quantite VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
