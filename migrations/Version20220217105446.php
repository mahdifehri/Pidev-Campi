 ...
 */
final class Version20220217105446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE image image CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\'');
    }
